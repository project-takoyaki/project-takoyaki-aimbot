...
#define VIRTUALIZER_TIGER_LONDON_START CustomVM00000133_Start();
#define VIRTUALIZER_TIGER_LONDON_END CustomVM00000133_End();
...
#define VIRTUALIZER_TIGER_LONDON_START CustomVM00000132_Start();
#define VIRTUALIZER_TIGER_LONDON_END CustomVM00000132_End();
...
#ifdef __BORLANDC__
  #include "VirtualizerSDK_BorlandC_inline_TIGER_LONDON.h"
#endif

#ifdef __GNUC__
  #include "VirtualizerSDK_GNU_inline_TIGER_LONDON.h"
#endif

#ifdef __ICL
  #include "VirtualizerSDK_ICL_inline_TIGER_LONDON.h"
#endif

#ifdef __LCC__
  #include "VirtualizerSDK_LCC_inline_TIGER_LONDON.h"
#endif

#if defined(_MSC_VER) || defined(__INTEL_COMPILER)
  #include "VirtualizerSDK_VC_inline_TIGER_LONDON.h"
#endif
